...
public record SystemResourceManagementModifyVO(
        @NotNull(groups = {SystemResourceValidationGroup.Modify.class}, message = "필수 값은 null 일 수 없습니다.")
        Long uid,

        RcManageResourceMethodEnum method,

        @Size(groups = {SystemResourceValidationGroup.Modify.class},
                max = 255,
                message = "최대 사이즈는 500자 이하여야 합니다."
        )
        @Pattern(groups = {SystemResourceValidationGroup.Modify.class},
                regexp = "^/([a-z-*]+(/)?)*$",
        ...
        @NotNull(groups = {SystemResourceValidationGroup.Modify.class}, message = "enabled 는 null 일 수 없습니다.")
