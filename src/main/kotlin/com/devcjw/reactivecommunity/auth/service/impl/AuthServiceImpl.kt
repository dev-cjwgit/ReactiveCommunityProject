...
class AuthServiceImpl(
            ...
            .flatMap {
                Mono.defer {
                    ...
                    redisTemplate.opsForValue()
                        ...
                        .thenReturn(AuthRepTokenVO(accessToken, refreshToken))
                }
            }
    }
    ...
    override fun reissue(authReqReissueDTO: AuthReqReissueDTO): Mono<AuthRepReissueVO> {
        /**
         * 1. r2dbc 에서 계정 정보 조회
         * 2. redis 에서 uid 조회
         * 3. refresh 확인
                ...
                redisTemplate.opsForValue().get(userEntity.uid)
                    .flatMap { storedRefreshToken ->
                        ...
                        if (storedRefreshToken == authReqReissueDTO.refreshToken) {
                            ...
                            Mono.just(AuthRepReissueVO(newAccessToken))
                        } else {
