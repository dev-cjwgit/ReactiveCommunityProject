...
CREATE TABLE IF NOT EXISTS `RC_BOARD` (
    ...
    CONSTRAINT `BOARD_BBS_UID_FK` FOREIGN KEY (`BBS_UID`) REFERENCES `RC_BOARD_BBS` (`UID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `BOARD_WRITER_UID_FK` FOREIGN KEY (`WRITER_UID`) REFERENCES `RC_USER` (`UID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `RC_BOARD_COMMENT` (
    ...
    CONSTRAINT `BOARD_COMMENT_BOARD_UID_FK` FOREIGN KEY (`BOARD_UID`) REFERENCES `RC_BOARD` (`UID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `FK_RC_BOARD_COMMENT_RC_USER` FOREIGN KEY (`WRITER_UID`) REFERENCES `RC_USER` (`UID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `RC_USER` (
    ...
    CONSTRAINT `USER_LEVEL_UID_FK` FOREIGN KEY (`LEVEL_UID`) REFERENCES `RC_USER_LEVEL` (`UID`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `RD_ROLE_RESOURCE` (
    ...
    CONSTRAINT `ROLE_RESOURCE_RESOURCE_UID_FK` FOREIGN KEY (`RESOURCE_UID`) REFERENCES `RC_USER_RESOURCE` (`UID`) ON UPDATE CASCADE
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
